...
class Server extends CI_Controller {
    ...
    function server_virtual($input)
    {
        // https://arjunphp.com/generate-excel-phpspreadsheet-codeigniter-php/

        //QUERY DATA
        $query = $this->server_model->virtual_data($input)->result();
        //
    ...
    function storage($input)
    {
        ...
        //QUERY DATA
        $query = $this->server_model->storage_data($input)->result();
        //
