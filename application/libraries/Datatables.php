  ...
  */
  class Datatables
  {
    ...
    */
    ...
    // hardcore order pharmacy 
    public function select_search_labList($columns, $backtick_protect = TRUE)
    {
      $this->ci->db->distinct('O.Reference AS REF');
      $this->ci->db->select("
                  
                  P.ID AS ID, 
                  P.MEDRECNBR AS TMRN, 
                  P.NAME AS NAME, 
                  LT.ORDER_TYPE AS TEST, 
                  LT.ORDER_NAME AS SUBTEST,
                  O.TIMESTAMP AS DATE, 
                  O.type, 
                  O.Reference AS REF,
                  E.FINANCIAL_NO AS FIN_NO,
                  LT.ORDER_TYPE + ' ' + LT.ORDER_NAME AS TEST_SUBTEST
                ");
      return $this;
    }
    // end
    ...
    */
    ...
    //hardcode
    public function where_date_search_labList($key_condition, $val = NULL, $backtick_protect = TRUE)
    {
      $key_condition = "CAST(O.TIMESTAMP AS DATE)=";
      $this->ci->db->where($key_condition, $val, $backtick_protect);
      return $this;
    }
    //enc 
    ...
    */
    ...
    // enchanchement
    public function newborn_notlike_born($key_condition, $val = NULL, $side = 'both')
    {
      //$this->like[] = array($key_condition, $val, $side);
      $this->ci->db->not_like("p.NAME",'B/O');
      return $this;
    }
    // end
